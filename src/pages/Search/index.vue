...
export default {
  ...
  methods: {
    ...
    // 删除面包屑
    removeCategoryName() {
      // 将不使用的参数设置为undefined可以减少路由传参提高效率
  ...
  watch: {
    $route: {
      handler() {
        // 将前一次的id置空，否则下一次发送请求可能会带上上一次的id参数
        this.searchParams.category1Id = undefined;
        this.searchParams.category2Id = undefined;
        this.searchParams.category3Id = undefined;
        // 在监视到变化后也要重新将参数传递
